/obj/item/clothing/pants/heavy_leather_pants
...
/obj/item/clothing/pants/heavy_leather_pants/shorts
...
/obj/item/clothing/pants/heavy_leather_pants/otavan
...
/obj/item/clothing/pants/heavy_leather_pants/otavan/generic
...
/obj/item/clothing/pants/heavy_leather_pants/otavan/generic/update_icon()
	. = ..()
	cut_overlays()
	if(get_detail_tag())
...
/obj/item/clothing/pants/heavy_leather_pants/grenzelpants
...
/obj/item/clothing/pants/heavy_leather_pants/grenzelpants/attack_hand_secondary(mob/user, params)
	. = ..()
	if(!picked)
...
/obj/item/clothing/pants/heavy_leather_pants/grenzelpants/update_icon()
	. = ..()
	cut_overlays()
	if(get_detail_tag())
		var/mutable_appearance/pic = mutable_appearance(icon(icon, "[icon_state][detail_tag]"))
...
/obj/item/clothing/pants/heavy_leather_pants/eastpants1
	name = "cut-throat's pants"
	desc = "Foreign pants, with leather insewns."
	icon_state = "eastpants1"
	allowed_race = RACES_PLAYER_ALL

/obj/item/clothing/pants/heavy_leather_pants/eastpants2
