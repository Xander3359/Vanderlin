...
/datum/outfit/job/wretch/hedgemage/pre_equip(mob/living/carbon/human/H)
	...
	cloak = /obj/item/clothing/suit/shirt/robe/black
	belt = /obj/item/storage/belt/leather
	beltr = /obj/item/reagent_containers/glass/bottle/manapot
	neck = /obj/item/clothing/neck/leather // No iron gorget vs necro. They will have to acquire one in round.
	beltl = /obj/item/storage/magebag
	backl = /obj/item/storage/backpack/satchel
	backr = /obj/item/weapon/woodstaff/ruby
	backpack_contents = list(
		/obj/item/spellbook_unfinished/pre_arcyne = 1,
		/obj/itemgem/amethyst = 1,
